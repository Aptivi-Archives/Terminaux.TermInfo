...
"%ProgramFiles%\dotnet\dotnet.exe" msbuild "..\src\Terminaux.TermInfo.sln" -t:restore -p:Configuration=%releaseconfig%
...
:build
echo Building...
"%ProgramFiles%\dotnet\dotnet.exe" msbuild "..\src\Terminaux.TermInfo.sln" -p:Configuration=%releaseconfig%
